...
class user
{
    ...
    public function update_user($ID, $username, $user_email, $old_pass, $new_pass): bool
    {
        ...
        if ($this->check_old_password($ID, $old_pass)) {
            ...
            $sql = 'UPDATE user SET user_name = :username, user_email = :user_email, user_pass = :new_pass WHERE ID = :ID';
