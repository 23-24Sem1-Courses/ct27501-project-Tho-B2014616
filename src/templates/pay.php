...
<body>
                ...
                <div class="checkout-form">
                    ...
                    <input type="hidden" name="ID_user" value="<?= htmlspecialchars($user->ID)?>">
                        <div class="form-group">
                            <label for="fullName"><i class="fas fa-user"></i> Người đặc hàng:</label>
                        ...
                        <div class="form-group">
                            <label for="phone"><i class="fas fa-map-marker-alt"></i> Địa chỉ</label>
                            <input type="text" class="form-control" id="phone" name="address" required>
                        </div>
                        <div class="form-group">
                            <label for="shippingMethod"><i class="fas fa-truck"></i> Phương thức giao hàng:</label>
                        ...
                        <div class="form-group">
                            <label for="paymentMethod"><i class="fas fa-credit-card"></i> Phương thức thanh
                                toán:</label>
                        ...
                        <div class="form-group">
                            <label for="notes"><i class="fas fa-comment"></i> Ghi chú đơn hàng:</label>
            ...
            <div class="col-md-6">
                ...
                <div class="product-list">
                    ...
                    <?php $sum=0; 
                        ...
                        <li><?= htmlspecialchars($soluong)?> - <?= htmlspecialchars($name)?> - <?=htmlspecialchars(number_format($price,0,",","."))?>VNĐ <i class="fas fa-check-circle"></i></li>
                    <?php $sum +=  $soluong     *$price;
                        endforeach ?>
                    </ul>
                    <div class="total-price">Tổng hóa đơn: <?=htmlspecialchars(number_format($sum,0,",","."))?>VNĐ</div>
                </div>
            </div>
        </div>
    ...
    <script>
    // Thêm địa chỉ giao hàng khác khi click
