    ...
    <div id="content">
        <div id="product-management-content">
            ...
            <p><strong>Ngày Mua: </strong> <?= htmlspecialchars($hoa_don ->timeDate->format('Y-m-d H:i:s')) ?></p>
                ...
                <table class="table table-bordered">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td style="width: 20px;"><?= htmlspecialchars($item->price) ?></td>
                            <td style="width: 20px;"><?= htmlspecialchars($item->price*$item->solg) ?></td>
                        </tr>
                        <?php $i++; 
                    endforeach ?>
                    </tbody>
